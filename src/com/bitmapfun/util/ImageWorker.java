...
public abstract class ImageWorker {
	 ...
	 * {@link com.bitmapfun.util.ImageWorker#processBitmap(Object)} to define the processing
	 * logic). A memory and disk cache will be used if an {@link ImageCache} has
	 * been set using {@link com.bitmapfun.util.ImageWorker#setImageCache(ImageCache)}. If the
	 ...
	 * image is found in the memory cache, it is set immediately, otherwise an
	 * {@link android.os.AsyncTask} will be created to asynchronously load the bitmap.
	 * {@link com.bitmapfun.util.ImageWorker#setAdapter(com.bitmapfun.util.ImageWorker.ImageWorkerAdapter)} must be called before
	 * using this method.
	 * 
	 * @param data
	 *            The URL of the image to download.
    ...
    public void setNoImage(int resId){
        mNoImageBitmap = BitmapFactory.decodeResource(mContext.getResources(), resId);
    }
	 ...
	 *            {@link com.bitmapfun.util.ImageWorker#loadImage(Object, android.widget.ImageView)}
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		protected void onPostExecute(Bitmap bitmap) {
			...
			}else if(bitmap==null && imageView!=null && mNoImageBitmap!=null){
                setImageBitmap(imageView,mNoImageBitmap);
            }
		}
